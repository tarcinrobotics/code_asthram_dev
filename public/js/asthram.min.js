...
Blockly.Workspace.prototype.deleteVariable = function (a) {
  ...
  if (-1 != c) {
    for (
      ...
      if (
        "procedures_defnoreturn" == g.type ||
        "procedures_defreturn" == g.type
      ) {
...
Blockly.ZoomControls.prototype.createDom = function () {
  ...
  var t = String(Math.random()).substring(2),
    o = Blockly.createSvgElement(
      "clipPath",
      { id: "blocklyZoomoutClipPath" + t },
      this.svgGroup_
    );
  Blockly.createSvgElement("rect", { width: 32, height: 32, y: 77 }, o);
  ...
  e.setAttributeNS(
    "http://www.w3.org/1999/xlink",
    "xlink:href",
    l.options.pathToMedia + Blockly.SPRITE.url
  ),
    (o = Blockly.createSvgElement(
      "clipPath",
    ...
    Blockly.createSvgElement("rect", { width: 32, height: 32, y: 43 }, o);
  var i = Blockly.createSvgElement(
    "image",
    {
      width: Blockly.SPRITE.width,
      height: Blockly.SPRITE.height,
  ...
  return (
    ...
    Blockly.createSvgElement("rect", { width: 32, height: 32 }, o),
    (t = Blockly.createSvgElement(
      "image",
      {
        width: Blockly.SPRITE.width,
        height: Blockly.SPRITE.height,
        ...
        ? ((this.dragMode_ = Blockly.DRAG_BEGIN),
          ...
          "mouseup" in Blockly.Touch.TOUCH_MAP &&
            ((Blockly.Touch.onTouchUpWrapper_ =
              Blockly.Touch.onTouchUpWrapper_ || []),
            (Blockly.Touch.onTouchUpWrapper_ =
              Blockly.Touch.onTouchUpWrapper_.concat(
                Blockly.bindEventWithChecks_(
                  document,
                  "mouseup",
                  null,
