...
goog.ui.MenuHeaderRenderer.CSS_CLASS = "header";
...
Blockly.ZoomControls.prototype.createDom = function() {
    ...
    e.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", l.options.pathToMedia + Blockly.SPRITE.url), o = Blockly.createSvgElement("clipPath", {
    ...
    return i.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", l.options.pathToMedia + Blockly.SPRITE.url), o = Blockly.createSvgElement("clipPath", {
    ...
    }, this.svgGroup_)).setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", l.options.pathToMedia + Blockly.SPRITE.url), Blockly.bindEventWithChecks_(t, "mousedown", null, function(t) {
        l.markFocused(), l.setScale(l.options.zoomOptions.startScale), l.scrollCenter(), Blockly.Touch.clearTouchIdentifier(), t.stopPropagation(), t.preventDefault()
    }), Blockly.bindEventWithChecks_(i, "mousedown", null, function(t) {
        l.markFocused(), l.zoomCenter(1), Blockly.Touch.clearTouchIdentifier(), t.stopPropagation(), t.preventDefault()
...
Blockly.FieldAngle.prototype.showEditor_ = function() {
    ...
    if (a.firstChild) {
        ...
        for (var c = 0; 360 > c; c += 10) Blockly.createSvgElement("line", {
